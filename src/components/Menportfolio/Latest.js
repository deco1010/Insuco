    ...
    <>
        <section className="portfolio-grid">
            <div className="container">
                ...
                <div className="col-md-6 col-lg-4 filter-item house">
                ...
                <div className="col-md-6 col-lg-4 filter-item business life">
                    <div className="portfolio-card">
                    <div className="portfolio-card__image">
                ...
                <div className="col-md-6 col-lg-4 filter-item car house">
                    <div className="portfolio-card">
                    <div className="portfolio-card__image">
                ...
                <div className="col-md-6 col-lg-4 filter-item study life">
                    <div className="portfolio-card">
                    <div className="portfolio-card__image">
