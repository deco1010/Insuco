        ...
        <header className="main-header main-header-four">
            ...
            <div className="topbar-one">
                ...
                <p className="topbar-one__left">
                    ...
                    Sun-Friday, 10am - 05pm
                </p>

                <div className="topbar-one__right">
                    <select name="language" className="topbar-one__select niceselect">
            ...
            <nav className="main-menu sticky-header">
                <div className="container">
                <div className="main-header-four__box">
            ...
            <nav className="main-menu sticky-header sticky-header--cloned sticky-fixed">
                <div className="container">
                    ...
                    <Link to="#" className="main-header__toggler mobile-nav__toggler">
                    <span />
                    <span />
                    <span />
                    </Link>
