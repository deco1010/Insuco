    ...
    <>
        <section className="about-one about-one--home-two">
            <div className="container">
                <img src="assets/images/shapes/about-1-a-1.png"  className="about-one--home-two__bg wow fadeInLeft" data-wow-duration="1500ms" />
                ...
                <div className="col-md-12 col-lg-6 d-flex">
                    ...
                    <div className="about-one__content">
                        ...
                        <li>
                            ...
                            <div className="bar">
                            <div className="bar-inner count-bar" data-percent="73%" style={{ width: "89%" }}>
